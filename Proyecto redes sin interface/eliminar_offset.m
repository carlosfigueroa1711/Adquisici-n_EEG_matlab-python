...
figure,
subplot 411, plot(AF3_o), title('Canal AF3'); xlabel('Muestras');ylabel('Uv');
subplot 412, plot(AF4_o), title('Canal AF4'); xlabel('Muestras');ylabel('Uv');
subplot 413, plot(F7_o), title('Canal F7');xlabel('Muestras');ylabel('Uv');
subplot 414, plot(F8_o), title('Canal F8');xlabel('Muestras');ylabel('Uv');
